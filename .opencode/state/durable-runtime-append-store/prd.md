...
- **Primary users:** App/server adapters that run `@yolk-sdk/agent/runtime` for persistent agent sessions.
...
- `@yolk-sdk/agent/protocol` message/event schemas for persisted payloads.
