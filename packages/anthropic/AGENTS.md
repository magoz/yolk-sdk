...
- Provider-specific constants, OAuth endpoints/scopes, auth URL helpers, broker helpers, header helpers, request lowering, and response/usage mapping belong here.
...
| `claude-provider` | Claude `LLMProvider` layer, request lowering, response/usage mapping |
