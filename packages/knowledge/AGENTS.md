...
`@yolk-sdk/knowledge` is the domain-free simple knowledge package. It models durable agent-readable documents, optional files/chunks, pinned context, search contracts, and lookup/manage tool factories.

## Role

- Define `KnowledgeDocument`, `KnowledgeFile`, `KnowledgeChunk`, status, availability, and scope schemas.
...
| `@yolk-sdk/knowledge/ingestion` | Generic search chunk ingestion helper |
