...
- `tools/knowledge-tool.ts`: `search_knowledge` + `get_knowledge_context`; Next/Workflow text and voice over user-owned knowledge chunks; omitted from Cloudflare bootstrap
